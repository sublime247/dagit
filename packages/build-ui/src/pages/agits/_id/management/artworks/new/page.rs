                ...
                div { class: "mb-8 mt-8",
                    ...
                    div { class: "space-y-4 max-w-4xl",
                        ...
                        DropdownInput {
                            ...
                            options: vec!["Trans".to_string(), "Offer".to_string()],
                            on_change: move |evt: String| {
                                ctrl.update_artwork_field("rarity".to_string(), evt.clone())
                            },
                        }
                        DropdownInput {
                            label: tr.stock,
                            ...
                            options: vec!["Trans".to_string(), "Offer".to_string()],
                            on_change: move |evt: String| {
                                ctrl.update_artwork_field("stock".to_string(), evt.clone())
                            },
                        }
                        ...
                        DropdownInput {
                            ...
                            options: vec!["Trans".to_string(), "Offer".to_string()],
                            on_change: move |evt: String| {
                                ctrl.update_artwork_field("price".to_string(), evt.clone())
                            },
                        }
                        DropdownInput {
                            label: tr.royalty,
                            ...
                            options: vec!["Trans".to_string(), "Offer".to_string()],
                            on_change: move |evt: String| {
                                ctrl.update_artwork_field("royalty".to_string(), evt.clone())
                            },
                        }
                      DropdownInput {
