#![allow(unused)]
use bdk::prelude::{by_components::icons::{arrows, edit, validations}, svg_attributes::to, *};
                     ...
                     {   collectors.into_iter().enumerate().map(|(_index, collector)| {
                            rsx! {
                                ...
                                onclick: move |_| {
                                    ...
                                    td { 
                                        class: "px-2 py-2 sm:px-4 sm:py-3 whitespace-nowrap",
                                        {collector.owned.to_string()}
                                    }
                                    td { 
                                        class: "px-2 py-2 sm:px-4 sm:py-3 whitespace-nowrap",
                                        div { 
                                            class: "flex space-x-1",
                                        {    collector.token_ids.iter().map(|token| {
                                                rsx! {
                                                    span { 
                                    ...
                                    td { 
                                        class: "px-2 py-2 sm:px-4 sm:py-3 whitespace-nowrap",
                                        {collector.wallet_address.clone()}
                                    }
                                    td { 
                                        class: "px-2 py-2 sm:px-4 sm:py-3 whitespace-nowrap",
                                        {collector.last_activity.clone()}
                                    }
                                    td { 
                                        class: "px-2 py-2 sm:px-4 sm:py-3 whitespace-nowrap",
                                        button { 
