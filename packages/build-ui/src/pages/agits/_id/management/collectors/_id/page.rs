            ...
            div { class: "flex flex-col w-full h-full text-white",
                ...
                div { class: "mb-10",
                    div { class: "flex space-x-8 text-sm font-medium",
                        button {
                            class: format!(
                                "pb-2 px-5 flex items-center space-x-1 {}",
                            ...
                            span { "Owned" }
                            span { class: "ml-1 px-1.5 py-0.5 rounded text-xs bg-white text-black font-semibold",
                                "585"
                            }
                        }
                        ...
                        match active_tab.with(|tab| tab.clone()) {
                            ...
                            AssetTab::Created => {
                                if *view_mode.read() == "nftImages" {
                                    ...
                                    rsx! {
                                        CreatedTable { assets: assets.clone(), lang }
                                    }
                                }
                            }
                            AssetTab::Trade => {
                                if *view_mode.read() == "nftImages" {
                                    ...
                                    rsx! {
                                        TradeTable { assets: assets.clone(), lang }
                                    }
                                }
                            }
                            AssetTab::Activity => {
